...
export default function AnalyticsScreen() {
  ...
  return (
    <>
      {/* KPIs */}
      <div className="col-span-4 tablet:col-span-8 desktop:col-span-12 grid grid-cols-2 gap-3 tablet:grid-cols-3 desktop:grid-cols-5">
      ...
      <div className="col-span-4 tablet:col-span-8 desktop:col-span-9 grid grid-cols-1 gap-3">
        {/* Food loss over time — actual vs predicted */}
        <Card className="p-4">
          <h2 className="text-headline-sm text-navy">Food Loss Over Time — Predicted vs Actual</h2>
          {series.data && series.data.overTime.length > 0 ? (
            ...
            <p className="mt-4 text-body-sm text-muted">No data.</p>
          )}
        </Card>
        ...
        <div className="grid grid-cols-1 gap-3 tablet:grid-cols-3">
          <Card className="p-4">
            ...
            <div className="mt-2">
              <BreakdownBarChart data={byCause} color={CHART_COLORS.excursion} />
            </div>
          </Card>
          <Card className="p-4">
            <h2 className="text-headline-sm text-navy">Loss by Product</h2>
            <div className="mt-2">
              <BreakdownBarChart data={byProduct} color={CHART_COLORS.measured} />
            </div>
          </Card>
          <Card className="p-4">
            <h2 className="text-headline-sm text-navy">Loss by Warehouse</h2>
            <div className="mt-2">
              <BreakdownBarChart data={byWarehouse} color={CHART_COLORS.calculated} />
            </div>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3 tablet:grid-cols-2">
          <Card className="p-4">
            ...
            <p className="text-body-sm text-muted">Predicted loss minus actual loss, per day</p>
